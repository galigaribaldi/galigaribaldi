<h1 align="left">Hi 👋, I'm Hernán Galileo Cabrera Garibaldi</h1>
...
- 🐍 **Backend APIs & Microservices** — Python (Flask, FastAPI, Django) · Go (Gin, net/http) · REST · AWS Lambda · Microservices
- 📊 **Data Engineering (ETL/ELT)** — PySpark · Apache Spark · Pandas · Kafka · AWS (Lambda, Step Functions, Glue, S3, CloudFormation, CloudWatch) · Snowflake
- 🗺️ **Geospatial Systems (GIS)** — GeoPandas · PostGIS · GeoJSON · QGIS · Shapely · Spatial SQL · Urban data pipelines
...
#### [Apimetro](https://github.com/galigaribaldi/Apimetro) 🚇
REST API that ingests, models, and serves structured geospatial data for Mexico City's public transit network.

**Stack:** Python · Flask · GeoPandas · PostGIS · GeoJSON · Spatial SQL  
**Context:** Research project for UNAM Urban Planning Master's — analyzing CDMX transit infrastructure.
...
![GeoJSON](https://img.shields.io/badge/GeoJSON-404040?style=flat&logo=json&logoColor=white)
...
- ✅ Scrum Developer Certified — Scrum Study (2025–2028)
- ✅ Safe Development — Net4skills (2025–2026)
- ✅ Azure Fundamentals AZ-900 — Microsoft (2021)
- ✅ Cisco CCNA S & R — Cisco (2019–2020)
...
- 🏊 Swimmer · ♟️ Competitive chess player · 📷 Urban & landscape photographer
- 📚 Passionate about fiction & horror literature (Stephen King forever)
- ✍️ Published author — *"La Historia de Quince"* (Letrame Editorial)
- 🌆 Urbanist by curiosity, engineer by training — I build tech that understands cities
